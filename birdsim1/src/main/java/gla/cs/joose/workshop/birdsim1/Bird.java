...
public class Bird extends Piece {
	 ...
	 * 
	 * @param color
	 *            The <code>Color</code> of the new piece.
	 **/
	Bird(Color color) {
		this.color = color;
	}
	...
	/**
	 * Draws this <code>Bird</code> on the given <code>Graphics</code>. Drawing
	 * should be limited to the provided <code>java.awt.Rectangle</code>.
	 * 
	 * @param g
